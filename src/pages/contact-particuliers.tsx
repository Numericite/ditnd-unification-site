...
import ContactParticuliersForm from "~/components/ui/ContactParticuliersForm/ContactParticuliersForm";
	...
	return (
		<>
			<Head>
				...
				<meta
					name="description"
					content="Adressez vos questions sur l'autisme et les troubles du neurodéveloppement à la Maison de l'autisme."
				/>
			</Head>
...
export const getServerSideProps: GetServerSideProps<Props> = async () => {
	...
	const tab = footer.contactParticuliers;
	const imageBanner =
	...
	return {
		props: {
			title:
				tab?.title ?? "Adressez-nous vos questions sur l'autisme et les TND",
